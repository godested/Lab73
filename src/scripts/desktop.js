...
const desktop = function () {
  ...
  timeLine.to(header, 0.5, {y: 0, ease: Power1.easeIn})
    ...
    .fromTo(title, 0.5, {y: 50}, {opacity: 1, y: 0}, 'headerTransitionEnd')
    .add('titleTransitionEnd')
    .fromTo(keywordBorder, 0.5, {width: '0'}, {width: '98%'}, 'titleTransitionEnd')
    .fromTo(description, 0.5, {y: 50}, {opacity: 1, y: 0}, 'titleTransitionEnd')
    ...
    .staggerFromTo(pageNavigation, 0.5, {y: 50}, {opacity: 1, y: 0}, 0.5);
